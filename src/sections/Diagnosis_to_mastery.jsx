...
import lineaCurva from "../assets/Diagnosis_to_mastery/linea-curva-diagnostic-to-mastery.png";

import tablet1 from "../assets/Diagnosis_to_mastery/tablet1.png";
import tablet2 from "../assets/Diagnosis_to_mastery/tablet2.png"
import tablet3 from "../assets/Diagnosis_to_mastery/tablet3.png";
import tablet4 from "../assets/Diagnosis_to_mastery/tablet4.png";
import tablet5 from "../assets/Diagnosis_to_mastery/tablet5.png";

import flecha from "../assets/Shared_Images/flecha.png";
import flechaTransparente from "../assets/Shared_Images/flecha-Transparente.png";
...
export default function Diagnosis_to_mastery() {
  ...
  const tablets = [
    { src: tablet1, title: "Initial Diagnosis", id: 1, marginLeft: "ml-[46px]"},
    ...
    { src: tablet3, title: "Real-time Feedback", id: 3, marginLeft: "ml-[72px]"},
    { src: tablet4, title: "Verifiable Growth", id: 4, marginLeft: "ml-[65px]"},
    { src: tablet5, title: "Life Impact", id: 5, marginLeft: "ml-[40px]"},
  ];
