...
import MoralDilemmasImg from "../assets/Moral Dilemmas.png";
import MoralDilemmasIcon from "../assets/moral-dilemmas-icon.png";
import TimeManagementImg from "../assets/Time Management Under Pressure.png";
import TimeManagementIcon from "../assets/time-management-under-pressure-icon.png";
import SplitPathImg from "../assets/Split-Path Decisions.png";
import SplitPathIcon from "../assets/split-path-decisions-icon.png";
import RoleSwapImg from "../assets/Role Swap.png";
import RoleSwapIcon from "../assets/role-swap-icon.png";
import EmotionDecoderImg from "../assets/Emotion Decoder.png";
import EmotionDecoderIcon from "../assets/emotion-decoder-icon.png";
import DialogueSimulationsImg from "../assets/Dialogue Simulations.png";
import DialogueSimulationsIcon from "../assets/dialogue-simulations-icon.png";
import PatternRecognitionImg from "../assets/Pattern Recognition Challenges.png";
import PatternRecognitionIcon from "../assets/pattern-recognition-challenges-icon.png";
