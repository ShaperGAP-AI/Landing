...
export default function What_Will_Do() {
  ...
  return (
    <div className="h-screen multi-gradient-bg pt-0 lg:pt-12 px-5 overflow-hidden pb-20">
      <div className="flex flex-col justify-evenly items-center min-h-[90vh] h-[90%]">
        {/* HEADER */}
        <div className="w-full flex flex-col gap-5">
          <h1 className="text-5xl font-bold text-center">
            <SplitText delay={0.2} className="text-black whitespace-nowrap" text={"Learn by"}></SplitText>
            <SplitText delay={0.4} className="text-darkpurple whitespace-nowrap" text={"living it"}></SplitText>
          </h1>
          <TypingEffect className="text-sm text-black/50 text-center lg:text-lg xl:text-xl" text={"Make decisions, solve dilemmas, decode emotions, and navigate challenges. This isn’t a course. It’s a journey."}></TypingEffect>
        </div>
        {/* ACTIVITIES */}
        ...
        <FadeInDiv delay={0.4} className="flex gap-5 sm:hidden">
