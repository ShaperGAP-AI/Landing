    ...
    <div className="w-full lg:h-full text-center py-10 lg:py-20 relative overflow-hidden">
      ...
      <div className='flex flex-col lg:flex-row mb-10 items-center justify-evenly w-full h-fit px-5 lg:px-20 text-white relative z-30'>
        <div className='lg:w-1/3 w-full text-start'>
            <h2 className='font-bold text-3xl lg:text-5xl'>Your Growth. <span className="text-lightpurple">Your</span>  <br />  <span className="text-lightpurple">Identity</span>. Verified.</h2>
            <p className='text-slate-500 text-md my-10'>Everything you do in Shaper GAP® is recorded, reflected, and stored in Linked® — your evolving, blockchain-verified skill identity.</p>
            <div>
        ...
        <img className='lg:w-1/3 lg:h-3/4 w-full h-full' src={telefono} alt="Teléfono" />
      </div>
      <div className='w-full mb-20 h-fit flex flex-col'>
        <div className='flex flex-wrap justify-around relative z-20 w-full lg:w-3/5 mx-auto'>
          <div className='flex flex-col w-3/7 lg:mb-0 mb-2 lg:w-48 hover:bg-lightpurple/30 transition-all duration-200 hover:shadow-lg hover:-translate-y-2 hover:shadow-darkpurple justify-center bg-lightpurple/10 rounded-2xl py-3 px-2'>
